...
## _4) Какие типы индексов поддерживаются в БД? Приведите пример создания индексов._
...
Вы можете найти документацию и материалы для обучения на [официальном сайте BigchainDB](https://www.bigchaindb.com/). 
В разделе [Documentation](https://docs.bigchaindb.com/en/latest/) вы найдете описание архитектуры и основных функций BigchainDB, а также руководства по установке и использованию. 
...
Кроме того, [на GitHub](https://github.com/bigchaindb)  доступен открытый исходный код BigchainDB и его дополнительных инструментов.
